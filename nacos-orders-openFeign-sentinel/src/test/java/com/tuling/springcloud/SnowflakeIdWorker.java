...
public class SnowflakeIdWorker {
    ...
    public synchronized long nextId() {
        ...
        long ll = 0l;
        if(b == 0){
            ll = ((timestamp - twepoch) << timestampLeftShift);
        ...
        if(b == 50){
            long lls = ((System.currentTimeMillis()+1000 - twepoch) << timestampLeftShift);
            System.out.println("最后："+lls);
            System.out.println("最后一次看看："+(lls > l));
        }
        return l;
    }
static int b = 0;
